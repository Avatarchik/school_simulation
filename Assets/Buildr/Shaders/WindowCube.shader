	...
	SubShader {
		...
		Pass {
			...
			v2f vert (a2v v) {
				...
				float3 d = position.xyz - _WorldSpaceCameraPos;
				o.dir.x = dot(d, tan0);
				o.dir.y = d.y;
				o.dir.z = dot(d, tan1);
				return o;
			...
			half4 frag( v2f i ) : COLOR {
				...
				//Enter pos
				float4 p = float4(f * float2(2.0, -2.0) - float2(1.0, -1.0), -1.0, 1.0);
				//Ray intersection
				float3 id = 1.0 / i.dir;
				...
				p.xyz += kMin * i.dir;
				//Sampler
				float4 interior = texCUBE(_InteriorTex, p);
